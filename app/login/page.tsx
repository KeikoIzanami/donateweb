        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg text-white text-sm font-medium transition-colors"
            >
